package com.example.duangniu000.test2.Util.IitemHelper;
 ...
 * {@link android.support.v7.widget.helper.ItemTouchHelper.Callback#onMove(RecyclerView, ViewHolder, ViewHolder)} and / or
 * {@link android.support.v7.widget.helper.ItemTouchHelper.Callback#onSwiped(ViewHolder, int)}.
 * <p>
 ...
 * overriding {@link android.support.v7.widget.helper.ItemTouchHelper.Callback#onChildDraw(Canvas, RecyclerView, ViewHolder, float, float, int,
 * boolean)}
 * or {@link android.support.v7.widget.helper.ItemTouchHelper.Callback#onChildDrawOver(Canvas, RecyclerView, ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     * {@link android.support.v7.widget.helper.ItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link android.support.v7.widget.helper.ItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see android.support.v7.widget.helper.ItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
     ...
     * {@link android.support.v7.widget.helper.ItemTouchHelper.Callback#onMove(RecyclerView, ViewHolder, ViewHolder)
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link ItemTouchUIUtil} that is used by the {@link android.support.v7.widget.helper.ItemTouchHelper.Callback} class for
         * visual
         ...
         * <p>
         * By default, {@link android.support.v7.widget.helper.ItemTouchHelper.Callback} applies these changes on
         ...
         * </pre>
         *
         * @return The {@link ItemTouchUIUtil} instance that is used by the {@link android.support.v7.widget.helper.ItemTouchHelper.Callback}
         */
         ...
         */
        public boolean isLongPressDragEnabled(ViewHolder viewHolder) {
            return true;
        }
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (child != null) {
                ...
                if (vh != null) {
                    boolean dragFlag = mCallback.hasDragFlag(mRecyclerView, vh);
                    if (!dragFlag) {
                        return;
                    }
