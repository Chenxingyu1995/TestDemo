 ...
 * </p>
 */
public class CoustomRefreshLayout extends ViewGroup implements NestedScrollingParent,
     ...
     * @param context
     */
    public CoustomRefreshLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public CoustomRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull CoustomRefreshLayout parent, @Nullable View child);
    }
}
