...
public class RefreshLayout2 extends ViewGroup {
    ...
    private void initView() {
        ...
        titleIcon = title.findViewById(R.id.titleImage);

        View foot = inflater.inflate(R.layout.refresh_title, this, true);
        footIcon = foot.findViewById(R.id.titleImage);
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (type == refresh_type.DOWN) {
                    ...
                    footIcon.setVisibility(VISIBLE);
                }
