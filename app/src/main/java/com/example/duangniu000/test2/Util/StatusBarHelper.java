...
public class StatusBarHelper {
    ...
    //导航栏颜色
    protected void setStatusBarColor(Activity activity, int statusBarColor) {
        if (Build.VERSION.SDK_INT >= 21) {
            //View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION  影藏 NavigationBar
    ...
    // 底部栏颜色
    protected void setNavigationBarColor(Activity activity, int avigationBarColor) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                activity.getWindow().setNavigationBarColor(avigationBarColor);
